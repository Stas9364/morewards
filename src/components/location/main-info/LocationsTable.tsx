        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center space-x-2 px-3 py-1 border border-gray-300 rounded-md bg-white text-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              ...
              <div className="absolute top-full left-0 mt-1 bg-white border border-gray-300 rounded-md shadow-lg z-10">
                {rowsPerPageOptions.map((option) => (
                  <button
                    ...
                    className="block w-full px-4 py-2 text-left text-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50"
                  >
                    <span>{option}</span>
                  </button>
                ))}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="p-2 rounded-md border border-gray-300 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
