          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-sm text-gray-600">{details.locations}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                <input
                  type="number"
                  value={tempDetails.locationUsers}
                  onChange={(e) =>
                    handleInputChange(
                      "locationUsers",
                      parseInt(e.target.value) || 0
                ...
                <p className="text-sm text-gray-600">{details.locationUsers}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-sm text-gray-600">{details.posDevices}</p>
              )}
            </div>
          </div>
        ...
        <div>
          ...
          <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden">
            <img
              ...
              alt="Restaurant interior with warm lighting and wooden furnishings"
